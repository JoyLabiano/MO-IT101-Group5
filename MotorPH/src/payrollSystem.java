...
public class payrollSystem {
    ...
    private static void displayEmployeeDetails(String[] employeeDetails) {
        if (employeeDetails != null) {
            ...
            double basicSalary = Double.parseDouble(employeeDetails[12]); // parse - extracts attributes from a local file and stores the information in the repository
            ...
            // Deductions
            double sssDeduction = 1000; // Example SSS deduction
            double philhealthDeduction = 500; // Example Philhealth deduction
            double withholdingTax = 0.10 * (grossIncome - sssDeduction - philhealthDeduction); // Example withholding tax
